package itextsharplgpl_monoforandroid_tester.itextsharplgpl_monoforandroid_tester;
...
public class TrialSplashScreen extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen.this, itextsharplgplmonoforandroidtester.TesterActivity.class);
